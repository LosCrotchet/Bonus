...
@onready var AssetEyeDefault = preload("res://game/entities/bobo/assets/eye_default.png")
@onready var AssetEyeClose = preload("res://game/entities/bobo/assets/eye_close.png")
@onready var AssetMouseOpen = preload("res://game/entities/bobo/assets/mouse_open.png")
@onready var AssetMousePlain = preload("res://game/entities/bobo/assets/mouse_default.png")
@onready var AssetMouseHappy = preload("res://game/entities/bobo/assets/mouse_happy.png")
@onready var AssetMouseDefault = preload("res://game/entities/bobo/assets/mouse_smile.png")
...
func update_Head():
	...
	var eye_gap = 65*ks / (distance+ks)
	var mouse_gap = 65*ks / (abs(delta_coordinate.y)+ks)
...
func set_mouse(statue:int):
	mouse_statue = statue
	if statue != -1:
		Mouse.texture = [AssetMouseDefault, AssetMouseHappy, AssetMouseOpen, AssetMousePlain][mouse_statue]
